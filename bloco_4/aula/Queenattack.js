...
// NOTE diagonal inferior direita
for (let lInfDir = 1; lInfDir < 8; lInfDir +=1) {
  let linhaAtualRainha = linhaRainha - lInfDir;
  let colunaAtualRainha = colunaRainha + lInfDir;

  if(linhaAtualRainha < 1 || colunaAtualRainha > 6) {
    break
  }
  if (linhaOponente === linhaAtualRainha && colunaAtualRainha === colunaAtualRainha) {
oportunidade = true;
